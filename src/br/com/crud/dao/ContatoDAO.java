...
public class ContatoDAO {
    public void save(Contato contato){
        /*
        * Isso é uma sql comum, os ? são os parametros que vamos adicionar na base de dados
        */
        ...
        try{
            ...
            //Adiciona o valot do terceiro parâmetro da sql
    ...
    public List<Contato> getContatos(){
        ...
        try{
            ...
            while(rset.next()){
                ...
                //Recupera a idade do banco e atribui ao objeto
